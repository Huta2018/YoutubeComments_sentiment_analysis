Sentiment analysis based on youtube comments on videos of Prakash Saput (Nepals top singer/performer/model). All comments are extracted from his youtube videos, see download_comments.py 
